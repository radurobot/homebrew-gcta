class Gcta < Formula
    ...
    if OS.linux?
      url "https://github.com/radurobot/go-code-test-analyzer/releases/download/v0.1.0/gcta-linux-amd64", using: :nounzip
      sha256 "c0d993b2884c61811deae2c40e4fbc8a44fb27bb4bc93e2e8189bf29eed4e8a2"
    elsif OS.mac? && Hardware::CPU.arm?
      url "https://github.com/radurobot/go-code-test-analyzer/releases/download/v0.1.0/gcta-darwin-arm64", using: :nounzip
      sha256 "d33396b846056f7cfb89cd6b804436981b9b36db50eed87ad2662bfd9842c55b"
    elsif OS.mac? && Hardware::CPU.intel?
      url "https://github.com/radurobot/go-code-test-analyzer/releases/download/v0.1.0/gcta-darwin-amd64", using: :nounzip
